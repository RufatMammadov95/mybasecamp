...
public class ProjectController {
	...
	public String viewProject(@PathVariable("id") Long id, Model model) {
		...
		model.addAttribute("discussions", discussionRepository.findByProjectIdOrderByCreatedAtAsc(id));
		...
		for (Attachment att : rawAttachments) {
			...
			if (att.getData() != null) {
				...
				String lowerName = att.getFileName().toLowerCase();
	...
	public String addDiscussion(@PathVariable("id") Long id, @RequestParam("content") String content,
